...
const indexedFileSchema = z.object({filename: z.string(), chunks: z.number(), status: z.enum(["indexed", "skipped", "failed"]), error: z.string().nullable().optional(), file_id: z.string().nullable().optional(), collection: z.string().nullable().optional()});
...
const ragFileSchema = z.object({file_id: z.string(), source_id: z.string(), filename: z.string(), subject: z.string().nullable().optional(), collection: z.string(), size_bytes: z.number(), content_hash: z.string(), chunks: z.number(), chunk_chars: z.number(), retrieval_top_k: z.number(), reranker_top_k: z.number(), embedding_model: z.string(), parser_version: z.string(), status: z.string(), updated_at: z.string().nullable().optional()});
const ragChunkSchema = z.object({id: z.string().nullable().optional(), chunk_id: z.string(), source_id: z.string(), filename: z.string(), page: z.number().nullable().optional(), chapter: z.string().nullable().optional(), chunk_index: z.number().nullable().optional(), content_hash: z.string(), parser_version: z.string(), text: z.string()});
